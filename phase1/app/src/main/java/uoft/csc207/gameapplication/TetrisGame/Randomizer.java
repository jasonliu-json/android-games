 ...
 * <p>
 * The 7-Bag-Randomization algorithm generates a sequence of all 7 pieces permuted randomly,
 * as if they were drawn from a bag. All 7 pieces are then dealt before generating another bag.
 * This ensures that the player does not get an extremely long drought without a desired piece.
 */
class Randomizer {
